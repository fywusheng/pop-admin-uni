    ...
    <template v-if="status === 0">
      <ul class="coupon-list" v-if="couponList1 && couponList1.length">
        <li class="coupon" :key="index" v-for="(coupon,index) in couponList1">
          ...
          <div class='coupon__description' @click='changeDesc(coupon)'>使用描述 <img v-if='coupon.showDesc' src='/static/images/me/up.png'> <img v-else src='/static/images/me/down.png'></div>
          <div class='coupon__description-content' v-if='coupon.showDesc'>{{ coupon.description }}</div>
        </li>
      </ul>
    ...
    <template v-if="status === 1">
      <ul class="coupon-list" v-if="couponList2 && couponList2.length">
        <li class="coupon disabled" :key="index" v-for="(coupon,index) in couponList2">
          ...
          <div class='coupon__description' @click='changeDesc(coupon)'>规则描述 <img v-if='coupon.showDesc' src='/static/images/me/up.png'> <img v-else src='/static/images/me/down.png'></div>
          <div class='coupon__description-content' v-if='coupon.showDesc'>{{ coupon.description }}</div>
        </li>
      </ul>
