<template>
  <div class="page-brand">
    ...
    <div class="brand-desc">
      ...
      <!--<img mode="aspectFit" class="btn-down" src="/static/images/common/icon-down.png">-->
    </div>
    <ul class="filter-list">
      ...
      <li class="filter" @click="changeFilter(sort)" :key="sort.id" v-for="sort in sortList"
        ...
        <img v-if="sort.sort === 1" class="filter-status" src="/static/images/common/down.png">
        <img v-else class="filter-status" src="/static/images/common/up.png">
      </li>
    </ul>
    <ul class="item-list">
      <li class="item" @click="toDetail(item)" v-for="(item,index) in itemList" :key="index">
        ...
        <div class="price-layout">
          ...
          <img class="icon-cart" src="/static/images/common/icon-cart.png">
        </div>
      </li>
    </ul>
