...
<template>
  <div id="app">
    <div class="search-header">
      <img class="icon" src="/static/images/common/icon-search.png">
      <input confirm-type="search" @confirm="search" :placeholder="key || '输入关键字搜索商品...'" v-model="key">
      <img class="btn-clear" src="/static/images/item-list/clear.png" @click="clear">
    </div>
    <ul class="sort-list">
      ...
      <li class="sort" @click="changeSortType(sortType === 11 ? 12 : 11)">
        ...
        <div class="img-wrap" v-if="sortType !== 11 && sortType !== 12">
          <img class="image" src="/static/images/item-list/up_n@2x.png">
          <img class="image" src="/static/images/item-list/down_n@2x.png">
        </div>
        <div class="img-wrap" v-if="sortType === 11">
          <img class="image" src="/static/images/item-list/up_h@2x.png">
          <img class="image" src="/static/images/item-list/down_n@2x.png">
        </div>
        <div class="img-wrap" v-if="sortType === 12">
          <img class="image" src="/static/images/item-list/up_n@2x.png">
          <img class="image" src="/static/images/item-list/down_h@2x.png">
        </div>
      </li>
      <!-- <li class="sort" @click="changeSortType(sortType === 31 ? 32 : 31)">
        销量
        <div class="img-wrap" v-if="sortType !== 31 && sortType !== 32">
          <img src="/static/images/item-list/up_n@2x.png">
          <img src="/static/images/item-list/down_n@2x.png">
        </div>
        <div class="img-wrap" v-if="sortType === 31">
          <img src="/static/images/item-list/up_h@2x.png">
          <img src="/static/images/item-list/down_n@2x.png">
        </div>
        <div class="img-wrap" v-if="sortType === 32">
          <img src="/static/images/item-list/up_n@2x.png">
          <img src="/static/images/item-list/down_h@2x.png">
        </div>
      </li> -->
      ...
      <li class="sort" @click="showFilter">
        筛选
        <img class="filter" src="/static/images/item-list/filter.png">
      </li>
    </ul>
    <scroll-view v-if="itemList.length || loading" scroll-y class="item-list-wrap" @scrolltolower="loadData" :lower-threshold="400">
      <ul class="item-list">
        <li class="item" @click="goItem(item)" v-for="(item,subIndex) in itemList" :key="subIndex">
          ...
          <div class="sale-out-wrap"
            ...
            <img class="sale-out" src="/static/images/item-list/sale-out.png">
          </div>
        </li>
      </ul>
    </scroll-view>
    <div v-else class="empty">
      <img src="/static/images/item-list/empty.png">
      没有搜到您想要的商品
      <div class="btn-home" @click="toHome">再去逛逛</div>
    </div>
    <top ref="toTop" :bottom="80" :showContact="false"></top>
    <search-filter ref="filter" @reset="reset" @changePrice="changePrice" @search="search" :priceList="priceList"
                   :attrList="attrList"
