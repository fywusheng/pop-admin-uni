  ...
  <div class="page-invoice" :class="{isIphoneHair}">
    ...
    <div class="info-wrap invoice-title-wrap">
      ...
      <template v-if="invoice.invoiceType == 0">
        <ul class="invoice-type">
          <li class="type" @tap="changeApplicantType(0)" :class="{active: invoice.applicantType == 0}">个人
          </li>
          <li class="type" @tap="changeApplicantType(1)" :class="{active: invoice.applicantType == 1}">公司
          </li>
        </ul>
      </template>
      <div class="company-info" v-if="invoice.applicantType == 0">
        <input type="text" v-model="invoice.invoiceTitle" maxlength="64" class="form-control" placeholder="请输入纳税人名称，默认‘个人’...">
      </div>
      <div class="company-info" v-if="invoice.applicantType== 1 || invoice.invoiceType == 1">
        <input type="text" v-model="invoice.invoiceTitle" maxlength="64" class="form-control" placeholder="请输入纳税单位名称...">
        <input type="text" v-model="invoice.identifyingCode" maxlength="20" class="form-control" placeholder="请输入纳税单位识别码...">
      </div>
      ...
      <template v-if="invoice.invoiceType == 0">
        ...
        <input type="text" v-model="invoice.recipientPhone" maxlength="11" class="form-control" placeholder="请输入收票人手机号码...">
        <input type="text" v-model="invoice.recipientEmail" maxlength="200" class="form-control" placeholder="请输入收票人电子邮箱...">
      </template>
    </div>
    <div class="line"></div>
    <div class="info-wrap">
      ...
      <ul class="invoice-content" v-model="invoice.invoiceContent">
        <li @click="changeInvoiceContent(1)">
          <img v-if="invoice.invoiceContent == 1" src="/static/images/common/select_h.png">
          <img v-else src="/static/images/common/select_n.png">
          服饰、鞋帽
        </li>
        <li @click="changeInvoiceContent(2)">
          <img v-if="invoice.invoiceContent == 2" src="/static/images/common/select_h.png">
          <img v-else src="/static/images/common/select_n.png">
          箱包
        </li>
        <li @click="changeInvoiceContent(3)">
          <img v-if="invoice.invoiceContent == 3" src="/static/images/common/select_h.png">
          <img v-else src="/static/images/common/select_n.png">
          礼品、办公用品
        </li>
        <li @click="changeInvoiceContent(4)">
          <img v-if="invoice.invoiceContent == 4" src="/static/images/common/select_h.png">
          <img v-else src="/static/images/common/select_n.png">
          订单商品明细
        </li>
      </ul>
