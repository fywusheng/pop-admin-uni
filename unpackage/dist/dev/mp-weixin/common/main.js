...
/***/ 0:
/*!***************************************************************************!*\
  !*** /Users/tongjiangfei/Downloads/workspace/learn/pop-admin-uni/main.js ***!
  \***************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(global, createApp) {__webpack_require__(/*! uni-pages */ 5);__webpack_require__(/*! ./utils/ald-stat/ald-stat */ 6);
...
__webpack_require__(/*! @/config/axios */ 16);
__webpack_require__(/*! @/utils/wx */ 15);
var _env = _interopRequireDefault(__webpack_require__(/*! @/config/env */ 56));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;

global.Store = _store.default;
global.State = _store.default.state;
...
_vue.default.mixin({
  ...
  methods: {
    _refs: function _refs(_ref) {
      return _.find(this.$children, { _ref: _ref });
    } },

  mounted: function mounted() {
    if (this.$mp && this.$mp.mpType === 'page') {var _this$$options =
      this.$options,loadDefaultData = _this$$options.loadDefaultData,data = _this$$options.data;
...
if (_vue.default.config) {
  // 还是不能捕获 异步钩子的错误..
  _vue.default.config.errorHandler = function () {var _console;
...
/***/ 10:
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/tongjiangfei/Downloads/workspace/learn/pop-admin-uni/App.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _uuidJs = _interopRequireDefault(__webpack_require__(/*! uuid-js */ 14));
...
{
  onLaunch: function onLaunch() {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {var deviceInfo, isIphoneX, isIphoneXS, isIphoneXSMAX, isIphoneXR;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
              console.log('app created');
              _wx.default.init();
              deviceInfo = _wx.default.getSystemInfoSync();
              App.systemInfo = deviceInfo;
              isIphoneX = /iPhone X/i.test(deviceInfo.model);
              // iPhone X or iPhone XS
              isIphoneXS = deviceInfo.platform === "ios" && deviceInfo.pixelRatio === 3 && deviceInfo.screenWidth === 375 && deviceInfo.screenHeight === 812;
              // iPhone XS Max
              isIphoneXSMAX = deviceInfo.platform === "ios" && deviceInfo.pixelRatio === 3 && deviceInfo.screenWidth === 414 && deviceInfo.screenHeight === 896;
              // iPhone XR
              isIphoneXR = deviceInfo.platform === "ios" && deviceInfo.pixelRatio === 2 && deviceInfo.screenWidth === 414 && deviceInfo.screenHeight === 896;
              App.isIphoneHair = isIphoneX || isIphoneXS || isIphoneXSMAX || isIphoneXR;
              if (!_wx.default.getStorageSync('deviceNumber')) {
                _wx.default.setStorageSync('deviceNumber', _uuidJs.default.create(4).toString());
              }
              App.updateCartNum = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var result;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.prev = 0;_context.next = 3;return (

                          _axios.default.get('/cart/getNum'));case 3:result = _context.sent;
                        if (result.code == 200 && result.data.cartNum > 0) {
                          _wx.default.setTabBarBadge({
                            index: 2,
                            text: "".concat(result.data.cartNum) });

                        } else {
                          _wx.default.removeTabBarBadge({
                            index: 2 });

                        }_context.next = 9;break;case 7:_context.prev = 7;_context.t0 = _context["catch"](0);case 9:case "end":return _context.stop();}}}, _callee, null, [[0, 7]]);}));case 11:case "end":return _context2.stop();}}}, _callee2);}))();
...
/***/ 57:
/*!*************************************************************************************************************!*\
  !*** /Users/tongjiangfei/Downloads/workspace/learn/pop-admin-uni/App.vue?vue&type=style&index=0&lang=scss& ***!
  \*************************************************************************************************************/
/*! no static exports found */
...
/***/ 58:
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--8-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--8-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-2!./node_modules/postcss-loader/src??ref--8-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/sass-loader/dist/cjs.js??ref--8-oneOf-1-4!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-5!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/tongjiangfei/Downloads/workspace/learn/pop-admin-uni/App.vue?vue&type=style&index=0&lang=scss& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 8:
/*!***************************************************************************!*\
  !*** /Users/tongjiangfei/Downloads/workspace/learn/pop-admin-uni/App.vue ***!
  \***************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _App_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./App.vue?vue&type=style&index=0&lang=scss& */ 57);
...
/***/ 9:
/*!****************************************************************************************************!*\
  !*** /Users/tongjiangfei/Downloads/workspace/learn/pop-admin-uni/App.vue?vue&type=script&lang=js& ***!
  \****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
